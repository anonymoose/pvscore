...
Start.prototype.setWorkflow=function(_3de9){
ImageFigure.prototype.setWorkflow.call(this,_3de9);
if(_3de9!==null&&this.outputPort===null){
this.outputPort=new MyOutputPort();
this.outputPort.setWorkflow(_3de9);
...
this.outputPort1.setWorkflow(_3de9);
...
this.outputPort2.setWorkflow(_3de9);
...
this.outputPort3.setWorkflow(_3de9);
