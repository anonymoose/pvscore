...
FieldModel.prototype.setTypeModel=function(_3d51){
if(!(_3d51 instanceof FieldTypeModel)){
throw "Invalid parameter type in [FieldModel.prototype.setTypeModel]";
}
this.typeModel=_3d51;
...
_3d52=Integer.toString(this.getTypeModel().getMaxLength());
