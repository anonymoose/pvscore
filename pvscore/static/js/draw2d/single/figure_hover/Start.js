...
Start.prototype.setWorkflow=function(_4632){
Node.prototype.setWorkflow.call(this,_4632);
if(_4632!==null){
this.outputPort1=new OutputPort();
this.outputPort1.setMaxFanOut(1);
this.outputPort1.setWorkflow(_4632);
...
this.outputPort2.setWorkflow(_4632);
