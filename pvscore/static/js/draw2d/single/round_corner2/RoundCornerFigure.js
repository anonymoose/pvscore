...
RoundCornerFigure.prototype.setContent=function(_39d8){
this.textarea.innerHTML=_39d8;
};
RoundCornerFigure.prototype.onDragstart=function(x,y){
var _39db=Node.prototype.onDragstart.call(this,x,y);
if(this.header===null){
return false;
}
...
RoundCornerFigure.prototype.setWorkflow=function(_39dd){
Node.prototype.setWorkflow.call(this,_39dd);
if(_39dd!==null&&this.inputPort===null){
this.inputPort=new InputPort();
this.inputPort.setWorkflow(_39dd);
this.inputPort.setName("input");
this.addPort(this.inputPort,-5,this.height/2);
this.outputPort=new OutputPort();
this.outputPort.setMaxFanOut(5);
this.outputPort.setWorkflow(_39dd);
