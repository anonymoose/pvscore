...
GroupFigure.prototype.onFigureEnter=function(_3d5e){
if(this.children[_3d5e.id]===null){
this.setBackgroundColor(this.highlightBackgroundColor);
}
CompartmentFigure.prototype.onFigureEnter.call(this,_3d5e);
};
GroupFigure.prototype.onFigureLeave=function(_3d5f){
CompartmentFigure.prototype.onFigureLeave.call(this,_3d5f);
this.setBackgroundColor(this.defaultBackgroundColor);
};
GroupFigure.prototype.onFigureDrop=function(_3d60){
CompartmentFigure.prototype.onFigureDrop.call(this,_3d60);
this.setBackgroundColor(this.defaultBackgroundColor);
};
