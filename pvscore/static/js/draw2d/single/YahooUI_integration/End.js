...
End.prototype.setWorkflow=function(_4635){
ImageFigure.prototype.setWorkflow.call(this,_4635);
if(_4635!==null&&this.inputPort===null){
this.inputPort=new MyInputPort();
this.inputPort.setWorkflow(_4635);
...
this.inputPort2.setWorkflow(_4635);
...
this.inputPort3.setWorkflow(_4635);
...
this.inputPort4.setWorkflow(_4635);
