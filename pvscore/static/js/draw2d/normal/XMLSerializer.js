...
XMLSerializer.toXML=function(obj, objectName, indentSpace)
{
   ...
   switch(t)
   {
      ...
      case "array":
         ...
         {
            s += XMLSerializer.toXML(obj[i], ('element'),indentSpace_plusOne );
         }
         s += indentSpace;
         break;
      default:
         if(obj!==null)
         {
            ...
            {
               s += XMLSerializer.toXML(attributes[name], name, indentSpace_plusOne);
            }
            s += indentSpace;
         }
      break;
...
XMLSerializer.xmlEncode=function(textToEncode)
{
