 ...
 * @since 0.9.18
 **/
Connection.prototype.setCanDrag=function(/*:boolean*/flag)
{
  this.canDrag= flag;
};
 ...
 *
 * @param {ConnectionDecorator} the new source decorator for the connection
 **/
 ...
 * Set the ConnectionDecorator for this object.
 *
 * @param {ConnectionDecorator} the new target decorator for the connection
 **/
 ...
 * of an connection.
 *
 * @param {ConnectionAnchor} the new source anchor for the connection
 **/
 ...
 *
 * @param {ConnectionAnchor} the new target anchor for the connection
 **/
