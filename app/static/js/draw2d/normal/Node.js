 ...
 * @type InputPort
 **/
Node.prototype.getInputPort= function(/*:String*/ portName)
{
  if(this.ports===null)
    return null;
  for(var i=0;i<this.ports.getSize();i++)
  {
   var port = this.ports.get(i);
   if(port.getName() == portName && port instanceof InputPort)
      return port;
  }
};
 ...
 * @type OutputPort
 **/
Node.prototype.getOutputPort= function(/*:String*/ portName)
{
  if(this.ports===null)
    return null;
  for(var i=0;i<this.ports.getSize();i++)
  {
   var port = this.ports.get(i);
   if(port.getName() == portName && port instanceof OutputPort)
      return port;
  }
};
