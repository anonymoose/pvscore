 ...
 * @param {WindowFigure} toolWindow The tool window of the canvas
 **/
Workflow.prototype.setToolWindow=function(/*:WindowFigure*/ toolWindow, /*:int*/x, /*:int*/y)
{
...
/**
 * @see WindowFigure#onSelectionChanged
 * @param {Object} w an object which implements the 'onSelectionChanged' method
 **/
Workflow.prototype.addSelectionListener=function(/*:Object*/ w)
{
  if(w!==null)
  {
 ...
 * Since version 0.9.18 you can select objects from type <b>Figure</b> too.
 *
