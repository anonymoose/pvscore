...
End.prototype.setWorkflow=function(_39d3){
ImageFigure.prototype.setWorkflow.call(this,_39d3);
if(_39d3!==null&&this.inputPort===null){
this.inputPort=new MyInputPort();
this.inputPort.setWorkflow(_39d3);
...
this.inputPort2.setWorkflow(_39d3);
...
this.inputPort3.setWorkflow(_39d3);
...
this.inputPort4.setWorkflow(_39d3);
