...
RoundCornerFigure.prototype.setContent=function(_4400){
this.textarea.innerHTML=_4400;
};
RoundCornerFigure.prototype.onDragstart=function(x,y){
var _4403=Node.prototype.onDragstart.call(this,x,y);
if(this.header===null){
return false;
}
...
RoundCornerFigure.prototype.setWorkflow=function(_4405){
Node.prototype.setWorkflow.call(this,_4405);
if(_4405!==null&&this.inputPort===null){
this.inputPort=new InputPort();
this.inputPort.setWorkflow(_4405);
this.inputPort.setName("input");
this.addPort(this.inputPort,-5,this.height/2);
this.outputPort=new OutputPort();
this.outputPort.setMaxFanOut(5);
this.outputPort.setWorkflow(_4405);
