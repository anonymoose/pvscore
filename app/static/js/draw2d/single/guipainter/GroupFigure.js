...
GroupFigure.prototype.onFigureEnter=function(_4434){
if(this.children[_4434.id]===null){
this.setBackgroundColor(this.highlightBackgroundColor);
}
CompartmentFigure.prototype.onFigureEnter.call(this,_4434);
};
GroupFigure.prototype.onFigureLeave=function(_4435){
CompartmentFigure.prototype.onFigureLeave.call(this,_4435);
this.setBackgroundColor(this.defaultBackgroundColor);
};
GroupFigure.prototype.onFigureDrop=function(_4436){
CompartmentFigure.prototype.onFigureDrop.call(this,_4436);
this.setBackgroundColor(this.defaultBackgroundColor);
};
