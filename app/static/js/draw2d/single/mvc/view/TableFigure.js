...
var _3626=this.model.getFieldModels();
for(var i=0;i<_3626.getSize();i++){
this.addColumn(_3626.get(i).getName(),_3626.get(i).getExtendedDescriptionLabel());
}
};
...
TableFigure.prototype.createCommand=function(_3629){
if(_3629.getPolicy()==EditPolicy.MOVE){
if(!this.canDrag){
return null;
}
