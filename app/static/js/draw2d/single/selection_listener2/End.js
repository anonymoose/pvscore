...
End.prototype.setWorkflow=function(_4456){
ImageFigure.prototype.setWorkflow.call(this,_4456);
if(_4456!==null&&this.inputPort===null){
this.inputPort1=new InputPort();
this.inputPort1.setWorkflow(_4456);
...
this.inputPort2.setWorkflow(_4456);
...
this.inputPort3.setWorkflow(_4456);
...
this.inputPort4.setWorkflow(_4456);
