...
Start.prototype.setWorkflow=function(_371d){
ImageFigure.prototype.setWorkflow.call(this,_371d);
if(_371d!==null&&this.outputPort===null){
this.outputPort1=new OutputPort();
this.outputPort1.setWorkflow(_371d);
...
this.outputPort2.setWorkflow(_371d);
...
this.outputPort3.setWorkflow(_371d);
...
this.outputPort4.setWorkflow(_371d);
