...
from .config.routes import crm_routes
...
def _config_impl(cfg):
    ...
    cfg.add_tween('app.controllers.tweens.request_context_tween_factory')
    cfg.add_tween('app.controllers.tweens.timing_tween_factory')
    crm_routes(cfg)
    cfg.add_route('home', '/')
    cfg.scan()
